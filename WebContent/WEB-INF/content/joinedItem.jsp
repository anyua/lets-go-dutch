				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12 col-sm-2">
							<a href="#"><img height="50" width="140" class="thumbnail"
								alt="现金支付" src="assets/images/alipay.jpg" /></a> <a href="#"><img
						...
						<div class="col-xs-12 col-sm-7">
							...
							<div class="profile-user-info profile-user-info-striped">
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span> <s:if test="updateActivity.type==0">  
											活动进行中
								...
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span> <s:iterator value="updateActivity.Members" id="m">
						...
						<div class="col-xs-12 col-sm-3">
							...
							<form class="<s:property value="updateActivity.id"/>">
								...
								<div class="clearfix">
									<input type="text" class="pull-left col-sm-4" id="form-field-1"
										name="message.amount" placeholder="差额">
								...
								<input type="hidden" name="activityId"
									value=<s:property value="updateActivity.id"/>>
							</form>
						</div>
					</div>
					<div class="row">
							...
							<table id="simple-table"
								...
								<s:iterator value="originalItem" id="i">
									<tr class="<s:property value="#i.id" />">
										...
										<td><button activityId="<s:property value="updateActivity.id" />" itemId="<s:property value="#i.id" />"
												class="btn btn-xs btn-warning outOfItem">我没去这个项目</button></td>
									</tr>
								</s:iterator>
								</tbody>
							</table>
